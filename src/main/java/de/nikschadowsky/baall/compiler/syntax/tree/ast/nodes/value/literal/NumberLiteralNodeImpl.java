...
public final class NumberLiteralNodeImpl extends AbstractNode implements NumberLiteralNode {
    ...
    public NumberLiteralNodeImpl(NodeDiagnosticCollector diagnostics) {
        super(diagnostics);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof NumberLiteralNodeImpl that)) return false;
    ...
    public <D, R> R accept(ASTVisitor<D, R> visitor, D data) {
        return visitor.visitNumberLiteral(this, data);
    }
}
