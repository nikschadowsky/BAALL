...
class ExpressionParserImplTest {
    ...
    void parseExpression() {
        ...
        assertThat(expressionParser.parseExpression(queue)).isSuccessful().resultMatches(node -> {
            ...
            return "MyIdentifier".equals(structInitializationLiteralNode.getIdentifier()
                                                                        .getIdentifier()
                                                                        .getIdentifier()
                                                                        .value());
        }).resultMatches(node -> {
        ...
        assertThat(expressionParser.parseExpression(queue)).isSuccessful().resultMatches(node -> {
            ...
            return "!".equals(prefixOperationNode.getOperator().getOperator().value());
        }).resultMatches(node -> {
            PrefixOperationNode prefixOperationNode = (PrefixOperationNode) node;
        ...
        assertThat(expressionParser.parseExpression(queue)).isSuccessful().resultMatches(node -> {
            ...
            BinaryExpressionNode binaryExpressionNode = (BinaryExpressionNode) node;
            return "+".equals(binaryExpressionNode.getOperator().getOperator().value());
        }).resultMatches(node -> {
            BinaryExpressionNode binaryExpressionNode = (BinaryExpressionNode) node;
        ...
        assertThat(expressionParser.parseExpression(queue)).isSuccessful()
                                                           ...
                                                           .resultMatches(node -> {
                                                               ...
                                                               BinaryExpressionNode innerExpression =
                                                                       (BinaryExpressionNode) parenthesizedExpressionNode.getInnerExpressionNode();
                                                               return "<<".equals(innerExpression.getOperator().getOperator().value());
                                                           }).resultMatches(node -> {
                                                               BinaryExpressionNode binaryExpressionNode =
                                                                       (BinaryExpressionNode) node;
                                                               ParenthesizedExpressionNode parenthesizedExpressionNode =
                                                               ...
                                                               return rightSideExpressionNode.getOperator().getOperator().value().equals("*");
                                                           }).resultMatches(node -> {
                                                               BinaryExpressionNode binaryExpressionNode = (BinaryExpressionNode) node;
                                                               BinaryExpressionNode rightSideExpressionNode =
                                                                       (BinaryExpressionNode) binaryExpressionNode.getRightOperand();
    ...
    void parseTerm() {
        ...
        assertThat(expressionParser.parseTerm(queue)).isSuccessful().resultMatches(node -> {
            ...
            return "MyIdentifier".equals(identifierNode.getIdentifier().getIdentifier().value());
        }).resultMatches(node -> {
            IdentifierAccessNode identifierNode = (IdentifierAccessNode) node;
        ...
        assertThat(expressionParser.parseTerm(queue)).isSuccessful().resultMatches(node -> {
            ...
            return "MyIdentifier".equals(functionCallNode.getFunctionIdentifier()
                                                         .getIdentifier()
                                                         .getIdentifier()
                                                         .value());
        }).resultMatches(node -> {
        ...
        assertThat(expressionParser.parseTerm(queue)).isSuccessful().resultMatches(node -> {
            ...
            UnaryExpressionNode unaryExpressionNode = (UnaryExpressionNode) node;
            return "++".equals(unaryExpressionNode.getOperator().getOperator().value());
        }).resultMatches(node -> {
            UnaryExpressionNode unaryExpressionNode = (UnaryExpressionNode) node;
            return "MyIdentifier".equals(unaryExpressionNode.getIdentifierAccess()
                                                            .getIdentifier()
                                                            .getIdentifier()
                                                            .value());
        }).resultMatches(node -> {
